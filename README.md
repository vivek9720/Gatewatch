...
Gatewatch is an offline C++17 toolkit for inspecting local defensive security artifacts. It helps security engineers and system administrators review packet captures, indicator files, IDS-style signatures, firewall exports, and lightweight policy files without sending data to a service.
...
Gatewatch includes libFuzzer-compatible robustness harnesses for the major parsers and stateful managers:
...
out/rules_state_fuzzer fuzz/corpus/rules_state_fuzzer -dict=fuzz/dictionary.txt -runs=1000
out/core_fuzzer fuzz/corpus/core_fuzzer -dict=fuzz/dictionary.txt -runs=1000
out/catalog_fuzzer fuzz/corpus/catalog_fuzzer -dict=fuzz/dictionary.txt -runs=1000
out/diagnostics_fuzzer fuzz/corpus/diagnostics_fuzzer -dict=fuzz/dictionary.txt -runs=1000
out/rule_manager_fuzzer fuzz/corpus/rule_manager_fuzzer -dict=fuzz/dictionary.txt -runs=1000
```
